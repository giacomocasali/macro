...
void waveform_2D_alignment() {
    ...
    TFile *file = TFile::Open("/home/giacomo/caendgz-sipmanalysis/data/final/data_x_90_y_0_vbias_57_run_0.root", "READ");
    ...
    hCh1Corr->Draw("COLZ"); c1->SaveAs("persistence_v58.png");
}